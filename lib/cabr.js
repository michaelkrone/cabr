...
function post(json, req, res) {
	...
	return new Promise((resolve, reject) =>
		Promise.resolve(this.options.userProvider.get(req))
			.then(user => Promise.resolve(this.rbac.provider.getRoles(user))
			.then(roles => Promise.mapSeries(_.keys(roles), r => Promise.resolve(this.rbac.provider.getAttributes(r)))
